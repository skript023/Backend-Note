...
class Activities
{
  public:
     ...
     */
    explicit Activities(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Activities(const Json::Value &pJson) noexcept(false);
     ...
     */
    Activities(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Activities>;
    friend drogon::orm::BaseBuilder<Activities, true, true>;
    friend drogon::orm::BaseBuilder<Activities, true, false>;
    friend drogon::orm::BaseBuilder<Activities, false, true>;
    friend drogon::orm::BaseBuilder<Activities, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Activities>;
#endif
