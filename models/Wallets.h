...
class Wallets
{
  public:
     ...
     */
    explicit Wallets(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
     ...
     */
    Wallets(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
